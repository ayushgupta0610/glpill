...
REELS = {
 ...
 "day4-rybelsus-morning": [
    ...
    ("bf",1.8,"the dose is basically GONE","GONE"),
    ("clock",2.2,"The rule: wait 30 minutes","30"),
    ("pw",2.2,"GLPill times that window for you","times"),
    ("hp",2.2,"down to the EXACT minute you can eat","EXACT"),
    ("coffee",2.0,"so you never miss it","never"),
 ],
 "day5-different-app": [
