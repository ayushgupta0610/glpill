...
REELS = {
 ...
 # day5 rebuilt 2026-07-23: fresh privacy-themed B-roll (emotional reel — no feature beats)
 "day5-different-app": [
    ("broll:gen-d5-bedroom.jpg",2.4,"Your weight. Your doses. Your worst days.",None),
    ("broll:gen-d5-phone.jpg",2.2,"On a GLP-1, that data is PERSONAL","PERSONAL"),
    ("broll:gen-d5-laptop.jpg",2.0,"Every other app wants to collect it","collect"),
    ("broll:gen-d5-curtains.jpg",2.0,"GLPill literally can't see yours","can't"),
    ("broll:gen-d5-box.jpg",2.0,"No account. No servers.","No"),
    ("broll:gen-d5-sofa.jpg",2.0,"It all stays on your phone","stays"),
    ("broll:gen-d5-tea.jpg",1.8,"Free — nothing to sell, nothing to harvest","Free"),
 ],
 ...
 # wk2-day1/day2 rebuilt 2026-07-23: fresh B-roll + app screen at the feature beat
 "wk2-day1-streak-breakers": [
    ("broll:gen-d1-nightstand.jpg",2.4,"Most people quit the pill for ONE reason","ONE"),
    ("broll:gen-d1-bed.jpg",2.0,"They lose the thread","lose"),
    ("broll:gen-d1-coffee.jpg",2.0,"One missed morning becomes three","three"),
    ("app:04-today-after-dose.png",2.6,"A streak keeps you honest","streak"),
    ("broll:gen-d1-clock.jpg",2.0,"and a nudge keeps you on time","nudge"),
    ("broll:gen-d1-phone.jpg",2.0,"GLPill does both — privately","both"),
    ("broll:gen-d1-journal.jpg",1.8,"and it's completely free","free"),
 ],
 "wk2-day2-wish-i-knew": [
    ("broll:gen-d2w-pillwater.jpg",2.4,"What I wish I knew before my first pill","wish"),
    ("broll:gen-d2w-handpill.jpg",2.0,"The empty-stomach window is everything","everything"),
    ("broll:gen-d2w-protein.jpg",2.0,"Protein protects your muscle","Protein"),
    ("broll:gen-d2w-water.jpg",2.0,"Water kills most of the nausea","Water"),
    ("app:01-onboarding-welcome.png",2.4,"Set it all up in 60 seconds","60"),
    ("broll:gen-d2w-journal.jpg",2.0,"GLPill keeps it on track","track"),
    ("broll:gen-d2w-phone.jpg",1.8,"privately, and free","free"),
 ],
 "wk2-day3-food-noise": [
